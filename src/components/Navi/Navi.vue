    ...
    <div style="margin-top:5px">
      <el-row :gutter="10">
        <el-col :xs="4" :sm="4" :md="4" :lg="4">
          <div>
            <el-menu default-active="1" class="el-menu-vertical-demo" style="min-height:800px" :router="true"><!--@select="handleSelect"-->
              <el-menu-item index="page1" ><i class="el-icon-message"></i>导航一</el-menu-item>
              <el-menu-item index="page2" ><i class="el-icon-menu"></i>导航二</el-menu-item>
